Слушай, давай перестанем вот это заново изобретать велосипед. Я откачу полностью ко вчерашнему рабочему коду оба файла, и ты просто заменишь те функции, которые нужны для просмотра новой колонки Max Price. Остальное ничего больше не трогай. Хорошо? Я тебе сейчас скину старый рабочий код.
import os
import time
import json
import base64
